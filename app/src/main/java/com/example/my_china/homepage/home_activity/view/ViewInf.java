package com.example.my_china.homepage.home_activity.view;
...
public interface ViewInf {
    void getMyBean(ZhongHe_ZiXun zhongHe_ziXun, ZhongHe_BoKe zhongHe_boKe, ZhengHe_DongTai zhongHe_dongtai);
}
